...
export default function GameCard({ title, genre, thumbnail, release, reviews, rating }) {
  return (
    <div className="flex flex-col justify-center h-72 2xl:h-80 cursor-pointer hover:opacity-80 hover:scale-105 transition-all duration-[150ms]">
      <img className="h-full rounded-t-xl" src={thumbnail !== undefined ? thumbnail : "assets/images/placeholder.jpg"} alt="image" />
      <div className="flex flex-col px-5 py-1 sm:py-2 bg-theme_dark_gray rounded-b-xl text-[15px]">
